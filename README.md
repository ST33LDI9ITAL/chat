...
- **📡 Nostr Multi-Relay Signaling**:
  - Concurrently connects to 6 public Nostr relays (`wss://relay.primal.net`, `wss://nos.lol`, `wss://relay.snort.social`, `wss://offchain.pub`, `wss://nostr.mom`, `wss://relay.ditto.pub`).
...
- **Hardcoded Relays**: The six default Nostr relays are hardcoded. There is currently no UI to add or remove relays.
